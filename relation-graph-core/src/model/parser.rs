...
impl FromStr for NamedNode {
    ...
    ///
    /// ```
    /// use relation_graph_core::model::NamedNode;
    /// use std::str::FromStr;
    ///
...
impl FromStr for BlankNode {
    ...
    ///
    /// ```
    /// use relation_graph_core::model::BlankNode;
    /// use std::str::FromStr;
    ///
...
impl FromStr for Literal {
    ...
    ///
    /// ```
    /// use relation_graph_core::model::{Literal, NamedNode, vocab::xsd};
    /// use std::str::FromStr;
    ///
...
impl FromStr for Term {
    ...
    ///
    /// ```
    /// use relation_graph_core::model::{Literal, Term};
    /// use std::str::FromStr;
    ///
...
impl FromStr for Variable {
    ...
    ///
    /// ```
    /// use relation_graph_core::sparql::Variable;
    /// use std::str::FromStr;
    ///
