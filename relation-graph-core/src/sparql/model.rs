...
impl QueryResults {
    ...
    /// use relation_graph_core::sparql::QueryResultsFormat;
    ///
...
impl QuerySolutionIter {
    ...
    /// ```
    /// use relation_graph_core::MemoryStore;
    /// use relation_graph_core::sparql::{QueryResults, Variable};
    ///
    /// let store = MemoryStore::new();
...
/// );
/// # Result::<_,relation_graph_core::sparql::VariableNameParseError>::Ok(())
/// ```
